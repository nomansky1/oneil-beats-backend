...
const SPANISH_LANDING_PAGES = [
  ...
  // ── 2026-05-13 — 16 new Spanish landings per the marketing-memo keyword
  // research. Each targets a long-tail Spanish search term with low
  // competition globally (most type-beat stores ignore Spanish entirely).
  // Estimated combined monthly search volume: 60K-120K across LatAm + US-Hispanic.
  {
    slug: 'beats-tipo-anuel',
    name: 'Beats Tipo Anuel AA',
    h1: 'Beats Tipo Anuel AA — Trap Latino y Reggaeton Oscuro',
    metaTitle: 'Beats Tipo Anuel AA | Trap Latino y Reggaeton',
    metaDescription: 'Beats tipo Anuel AA: trap latino oscuro, 808s pesados, reggaeton con actitud. Originales mezclados en estudio. Licencias desde $29.99.',
    intro: 'Anuel AA marcó el sonido del trap latino oscuro y el reggaeton con actitud. Estos beats viven en esa zona — 808s densos, melodías frías, energía de calle. Licencias desde $29.99.',
    enAlt: '/anuel-type-beat',
    filter: (b) => b.subgenre === 'Latin Trap' || (b.genre === 'Reggaeton' && /dark|hard|aggressive/i.test(b.mood || '')),
    seedKeyword: 'Latin Trap',
  },
  {
    slug: 'beats-tipo-karol-g',
    name: 'Beats Tipo Karol G',
    h1: 'Beats Tipo Karol G — Reggaeton Sensual y Pop Latino',
    metaTitle: 'Beats Tipo Karol G | Reggaeton Sensual y Pop',
    metaDescription: 'Beats tipo Karol G: reggaeton sensual, pop latino moderno, melodías femeninas. Originales con producción global. Licencias desde $29.99.',
    intro: 'Karol G empujó el reggaeton hacia el pop global sin perder la sensualidad. Estos beats están en esa misma línea: melodías cantables, sintes brillantes, drops controlados. Licencias desde $29.99.',
    enAlt: '/karol-g-type-beat',
    filter: (b) => b.genre === 'Reggaeton' && /smooth|sensual|romantic|melodic/i.test(b.mood || ''),
    seedKeyword: 'Sensual Reggaeton',
  },
  {
    slug: 'beats-tipo-rauw-alejandro',
    name: 'Beats Tipo Rauw Alejandro',
    h1: 'Beats Tipo Rauw Alejandro — Reggaeton Alternativo y Pop Urbano',
    metaTitle: 'Beats Tipo Rauw Alejandro | Reggaeton Alternativo',
    metaDescription: 'Beats tipo Rauw Alejandro: reggaeton alternativo, R&B latino, fusión pop urbano. Producción original con vibe experimental. Licencias desde $29.99.',
    intro: 'Rauw Alejandro mezcla reggaeton, R&B y pop urbano en algo que solo él hace. Estos beats encajan en esa fusión: ambientes amplios, melodías nostálgicas, ritmo bailable. Licencias desde $29.99.',
    enAlt: '/rauw-alejandro-type-beat',
    filter: (b) => b.genre === 'Reggaeton' && /smooth|melodic|dreamy|chill/i.test(b.mood || ''),
    seedKeyword: 'Modern Reggaeton',
  },
  {
    slug: 'beats-tipo-myke-towers',
    name: 'Beats Tipo Myke Towers',
    h1: 'Beats Tipo Myke Towers — Trap Latino Melódico',
    metaTitle: 'Beats Tipo Myke Towers | Trap Latino y Reggaeton',
    metaDescription: 'Beats tipo Myke Towers: trap latino melódico, reggaeton suave con flow de rap. Originales mezclados en estudio. Licencias desde $29.99.',
    intro: 'Myke Towers vive en la frontera entre trap latino, reggaeton y rap melódico. Estos beats funcionan en esa zona — perfectos para verso y hook intercambiables. Licencias desde $29.99.',
    enAlt: '/myke-towers-type-beat',
    filter: (b) => b.genre === 'Reggaeton' || b.subgenre === 'Latin Trap',
    seedKeyword: 'Latin Trap',
  },
  {
    slug: 'beats-tipo-quevedo',
    name: 'Beats Tipo Quevedo',
    h1: 'Beats Tipo Quevedo — Trap Español y Reggaeton Moderno',
    metaTitle: 'Beats Tipo Quevedo | Trap Español y Reggaeton',
    metaDescription: 'Beats tipo Quevedo: trap español moderno, reggaeton suave, fusión post-Bizarrap. Producción original. Licencias desde $29.99.',
    intro: 'Quevedo es la cara más visible del trap español moderno post-Bizarrap Session #52. Estos beats están en esa onda — melodías limpias, drums golpeados, vibe relajada. Licencias desde $29.99.',
    enAlt: '/quevedo-type-beat',
    filter: (b) => b.genre === 'Reggaeton' || b.subgenre === 'Latin Trap',
    seedKeyword: 'Modern Reggaeton',
  },
  {
    slug: 'beats-tipo-young-miko',
    name: 'Beats Tipo Young Miko',
    h1: 'Beats Tipo Young Miko — Perreo Femenino y Reggaeton',
    metaTitle: 'Beats Tipo Young Miko | Perreo y Reggaeton Femenino',
    metaDescription: 'Beats tipo Young Miko: perreo, reggaeton femenino con energía, flow rápido y melodía moderna. Originales mezclados. Licencias desde $29.99.',
    intro: 'Young Miko abrió el carril del perreo femenino moderno con flow rápido y melodías ásperas. Estos beats funcionan con esa energía. Licencias desde $29.99.',
    enAlt: '/young-miko-type-beat',
    filter: (b) => b.genre === 'Reggaeton' && /energetic|bouncy|hard/i.test(b.mood || ''),
    seedKeyword: 'Perreo',
  },
  {
    slug: 'beats-tipo-peso-pluma',
    name: 'Beats Tipo Peso Pluma',
    h1: 'Beats Tipo Peso Pluma — Corridos Tumbados y Pop Mexicano',
    metaTitle: 'Beats Tipo Peso Pluma | Corridos Tumbados y Trap Latino',
    metaDescription: 'Beats tipo Peso Pluma: corridos tumbados modernos, fusión con trap latino y pop mexicano. Producción original. Licencias desde $29.99.',
    intro: 'Peso Pluma reventó el género urbano mexicano con corridos tumbados que cruzaron a global. Estos beats funcionan con esa fusión: trap-vibes con melodías mexicanas. Licencias desde $29.99.',
    enAlt: '/peso-pluma-type-beat',
    filter: (b) => b.subgenre === 'Latin Trap' || b.genre === 'Trap' || (b.genre === 'Reggaeton' && /melodic|nostalgic/i.test(b.mood || '')),
    seedKeyword: 'Latin Trap',
  },
  {
    slug: 'beats-tipo-bizarrap',
    name: 'Beats Tipo Bizarrap',
    h1: 'Beats Tipo Bizarrap — Beats para Music Sessions',
    metaTitle: 'Beats Tipo Bizarrap | BZRP Music Sessions Style',
    metaDescription: 'Beats tipo Bizarrap: sintes minimalistas, drums house-influenced, espacio para vocals. Producción original al estilo BZRP. Licencias desde $29.99.',
    intro: 'Bizarrap inventó un formato — minimalismo melódico con drums house y espacio para que el verso brille. Estos beats están en ese pocket. Licencias desde $29.99.',
    enAlt: '/bizarrap-type-beat',
    filter: (b) => b.genre === 'Reggaeton' || b.subgenre === 'Latin Trap',
    seedKeyword: 'Modern Reggaeton',
  },
  {
    slug: 'beats-tipo-j-balvin',
    name: 'Beats Tipo J Balvin',
    h1: 'Beats Tipo J Balvin — Reggaeton Pop Global',
    metaTitle: 'Beats Tipo J Balvin | Reggaeton Pop Global',
    metaDescription: 'Beats tipo J Balvin: reggaeton pop global con producción limpia, sintes brillantes, drops radio-ready. Originales mezclados en estudio. Licencias desde $29.99.',
    intro: 'J Balvin construyó el sonido reggaeton-pop global — limpio, radio-ready, internacional. Estos beats encajan ahí. Licencias desde $29.99.',
    enAlt: '/j-balvin-type-beat',
    filter: (b) => b.genre === 'Reggaeton' && (b.subgenre === 'Modern Reggaeton' || /smooth|uplifting|happy/i.test(b.mood || '')),
    seedKeyword: 'Modern Reggaeton',
  },
  {
    slug: 'beats-tipo-ozuna',
    name: 'Beats Tipo Ozuna',
    h1: 'Beats Tipo Ozuna — Reggaeton Romántico y Melódico',
    metaTitle: 'Beats Tipo Ozuna | Reggaeton Romántico Melódico',
    metaDescription: 'Beats tipo Ozuna: reggaeton romántico, melodías suaves, voz central. Originales mezclados en estudio. Licencias desde $29.99.',
    intro: 'Ozuna construyó su fama con reggaeton romántico de melodías limpias y voz al frente. Estos beats funcionan con esa estética. Licencias desde $29.99.',
    enAlt: '/ozuna-type-beat',
    filter: (b) => b.genre === 'Reggaeton' && /smooth|romantic|sensual|melodic/i.test(b.mood || ''),
    seedKeyword: 'Sensual Reggaeton',
  },
  {
    slug: 'beats-tipo-anitta',
    name: 'Beats Tipo Anitta',
    h1: 'Beats Tipo Anitta — Funk Brasileiro y Reggaeton Pop',
    metaTitle: 'Beats Tipo Anitta | Funk Brasileiro y Reggaeton Pop',
    metaDescription: 'Beats tipo Anitta: funk brasileiro fusión con reggaeton pop, dancehall y pop global. Originales mezclados. Licencias desde $29.99.',
    intro: 'Anitta cruza funk brasileiro, reggaeton, dancehall y pop. Estos beats funcionan en esa fusión bailable. Licencias desde $29.99.',
    enAlt: '/anitta-type-beat',
    filter: (b) => b.genre === 'Reggaeton' || b.genre === 'Dancehall',
    seedKeyword: 'Modern Reggaeton',
  },
  {
    slug: 'pistas-de-reggaeton',
    name: 'Pistas de Reggaeton',
    h1: 'Pistas de Reggaeton — Catálogo Completo de Instrumentales',
    metaTitle: 'Pistas de Reggaeton | Instrumentales para Cantar',
    metaDescription: 'Pistas de reggaeton originales para artistas. Moderno, perreo, dembow, sensual. MP3 y WAV con entrega inmediata. Licencias desde $29.99.',
    intro: 'Pistas de reggaeton listas para que grabes encima. Mezcladas y masterizadas en estudio. Modernas, sensuales, perreo, dembow — el catálogo completo. Licencias desde $29.99.',
    enAlt: '/reggaeton-beats',
    filter: (b) => b.genre === 'Reggaeton',
    seedKeyword: 'Reggaeton',
  },
  {
    slug: 'pistas-de-perreo',
    name: 'Pistas de Perreo',
    h1: 'Pistas de Perreo — Instrumentales para Mover la Pista',
    metaTitle: 'Pistas de Perreo | Instrumentales para Perrear',
    metaDescription: 'Pistas de perreo intensas y bailables. Dembow, perreo intenso, energía discoteca. Originales mezcladas. Licencias desde $29.99.',
    intro: 'Pistas de perreo con la energía que necesitas para reventar la discoteca. Dembow puro, perreo intenso, drops bailables. Licencias desde $29.99.',
    enAlt: '/perreo-beats',
    filter: (b) => b.genre === 'Reggaeton' && /energetic|bouncy|hard/i.test(b.mood || ''),
    seedKeyword: 'Perreo',
  },
  {
    slug: 'beats-de-reggaeton-romantico',
    name: 'Beats de Reggaeton Romántico',
    h1: 'Beats de Reggaeton Romántico — Sensual y Melódico',
    metaTitle: 'Beats de Reggaeton Romántico | Sensual y Melódico',
    metaDescription: 'Beats de reggaeton romántico, sensual, perfecto para baladas y canciones de amor en reggaeton. Originales mezclados. Licencias desde $29.99.',
    intro: 'Reggaeton romántico con melodías suaves, ritmo bailable pero íntimo, ideal para canciones de amor. Estos beats te dan el espacio para que la letra brille. Licencias desde $29.99.',
    enAlt: '/reggaeton-beats',
    filter: (b) => b.genre === 'Reggaeton' && /smooth|romantic|sensual|melancholic/i.test(b.mood || ''),
    seedKeyword: 'Sensual Reggaeton',
  },
  {
    slug: 'beats-de-reggaeton-old-school',
    name: 'Beats de Reggaeton Old School',
    h1: 'Beats de Reggaeton Old School — Estilo Daddy Yankee, Don Omar',
    metaTitle: 'Beats de Reggaeton Old School | Estilo Daddy Yankee',
    metaDescription: 'Beats de reggaeton old school al estilo Daddy Yankee, Don Omar, Tego Calderón. Dembow clásico con producción moderna. Licencias desde $29.99.',
    intro: 'El reggaeton old school — la era Daddy Yankee, Don Omar, Tego — fue dembow clásico, drums duros y melodías ásperas. Estos beats respetan esa estética con producción moderna. Licencias desde $29.99.',
    enAlt: '/reggaeton-beats',
    filter: (b) => b.genre === 'Reggaeton' && /hard|energetic|aggressive/i.test(b.mood || ''),
    seedKeyword: 'Reggaeton',
  },
  {
    slug: 'instrumentales-de-trap-latino',
    name: 'Instrumentales de Trap Latino',
    h1: 'Instrumentales de Trap Latino — Catálogo Completo',
    metaTitle: 'Instrumentales de Trap Latino | Originales Mezclados',
    metaDescription: 'Instrumentales de trap latino originales: oscuros, melódicos, con 808s pesados. MP3 y WAV. Licencias desde $29.99 con entrega inmediata.',
    intro: 'Instrumentales de trap latino: 808s pesados, melodías oscuras, drums con peso. Producción original mezclada y masterizada en estudio. Licencias desde $29.99.',
    enAlt: '/trap-beats',
    filter: (b) => b.subgenre === 'Latin Trap' || b.genre === 'Trap',
    seedKeyword: 'Latin Trap',
  },
];
